// DDrawReader.cpp : Defines the entry point for the application.
//
#include "pch.h"
#include <crtdbg.h>
					  ...
					  _In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_DDRAWREADER, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_DDRAWREADER));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_DDRAWREADER));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_DDRAWREADER);
