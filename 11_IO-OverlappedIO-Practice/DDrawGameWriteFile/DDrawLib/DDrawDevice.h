...
class CDDrawDevice
{
	...
	BOOL	m_bUseWriteToFile = FALSE;
	char*	m_pWriteBuffer = nullptr;
	DWORD	m_dwWriteBufferPitch = 0;
	
	char*	m_pScratchBuffer = nullptr;
	DWORD	m_dwScratchBufferWidth = 0;
	DWORD	m_dwScratchBufferHeight = 0;
	...
	IFileWriter* m_pCurFileWriter = nullptr;
...
public:
	...
	BOOL	BeginDraw(BOOL bWriteToFile, IFileWriter* pFileWriter);
	void	EndDraw();
