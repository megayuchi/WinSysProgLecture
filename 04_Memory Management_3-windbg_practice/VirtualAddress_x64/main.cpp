...
int main()
{
	...
	UINT64 AddrInEntryMask = 0b0000000000000000111111111111111111111111111111111111000000000000;
	...
	DWORD PageDirectoryPointer = (DWORD)((Addr >> 9 >> 9 >> 12) & 0b111111111);
	DWORD PageMapLevel4 = (DWORD)((Addr >> 9 >> 9 >> 9 >> 12) & 0b111111111);

	wprintf_s(L"Address : %p\n", Addr);
	wprintf_s(L"Page Map Level4 : %03x(%d)\n", PageMapLevel4, PageMapLevel4);
